        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
          {categories.map((cat, idx) => (
            <Link
              ...
              className="card-lift flex flex-col items-center gap-3 p-4 bg-white rounded-2xl border border-stone-200 hover:border-primary-300 hover:shadow-md group"
            ...
            >
              ...
              <span className="text-xs font-semibold text-gray-700 text-center leading-tight group-hover:text-primary-600 smooth-transition">{cat.name}</span>
            </Link>
          ))}
        </div>
      </section>
