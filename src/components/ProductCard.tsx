      ...
      <Link to={`/products/${product.id}`} className="block overflow-hidden aspect-[4/3] bg-dark-700 relative">
        {product.image_url ? (
          <>
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-primary-500 via-transparent to-transparent opacity-0 group-hover:opacity-20 transition-opacity duration-500 pointer-events-none" />
          </>
        ) : (
